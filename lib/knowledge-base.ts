...
export interface KbResource {
  ...
  // One-line "when to use this" summary. This is what triage sees, so it can pick a resource without the full guidance.
  triageHint: string
  guidance: string
}
...
export const KNOWLEDGE_BASE: KbResource[] = [
  {
    ...
    alwaysEscalate: true,
    triageHint:
      "Immigration, CAS, visa, or right-to-work questions about a person's own situation. Regulated, always routes to a person.",
    guidance:
  ...
  },
  {
    ...
    category: "financial",
    triageHint:
      "Short-term or emergency money problems: delayed loan or bursary, sudden shortfall, or being unable to afford rent, food, or bills.",
    guidance:
  ...
  },
  {
    ...
    category: "housing",
    triageHint:
      "Getting a tenancy deposit back, disputed deductions, or deposit protection schemes.",
    guidance:
  ...
  },
  {
    ...
    category: "academic",
    triageHint:
      "Finding past exam papers, reading lists, or core study materials through the library.",
    guidance:
  ...
  },
  {
    ...
    category: "academic",
    triageHint:
      "Illness, bereavement, or a serious unforeseen event affecting an assessment or deadline; extensions and mitigation.",
    guidance:
  ...
  },
  {
    ...
    category: "other",
    triageHint:
      "University account or IT problems: sign-in, email, the VLE, Wi-Fi, software, password resets, or MFA.",
    guidance:
  ...
  },
  {
    ...
    category: "health",
    triageHint:
      "Disability, long-term health, mental-health condition, or specific learning difficulty needing reasonable adjustments or support.",
    guidance:
  ...
  },
  {
    ...
    category: "financial",
    triageHint:
      "Tuition fees, paying in instalments, or what happens if a payment is late.",
    guidance:
  ...
  },
  {
    ...
    category: "other",
    triageHint:
      "CVs, applications, interviews, internships, or finding part-time work; general job-seeking help.",
    guidance:
  ...
  },
  {
    ...
    category: "health",
    triageHint:
      "Non-urgent mental health and wellbeing: stress, low mood, anxiety, homesickness, struggling to cope, or wanting to talk to someone.",
    guidance:
  ...
  },
  {
    ...
    alwaysEscalate: true,
    triageHint:
      "Reporting harassment, bullying, hate, or sexual misconduct. Sensitive, always routes to a person.",
    guidance:
